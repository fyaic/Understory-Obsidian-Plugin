...
<p align="center">
  <img src="assets/understory-logo.png" alt="Understory 叶子蜡笔画" width="220">
</p>
...
默认体验从 **Continue with Bondie** 开始。登录一次即可使用托管 Understory 服务，不需要了解或配置背后的 AI 服务、安装 Python 或填写 endpoint。
...
<p align="center">
  <img src="assets/readme/understory-sidebar-suggestions.png" alt="Understory 右侧栏在 DemoVault 定价笔记中展示分组关联建议" width="760">
</p>
...
<p align="center">
  <img src="assets/readme/understory-sidebar-risks.png" alt="Understory Risks 页展示套餐限制冲突和过期 billing 文案主张" width="760">
</p>
...
托管模式以账号为入口。**Continue with Bondie** 会打开浏览器登录，并回到同一个 vault。托管 AI 路由和服务凭据只保留在 Understory 服务器；插件不会收到 provider 或模型选择。
...
当前版本：`1.13.10`。Understory 目标版本为 Obsidian `1.8.7` 或更新版本，仅支持桌面端。
